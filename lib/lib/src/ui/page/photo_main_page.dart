...
import 'package:flutter_advance_image_picker/lib/src/engine/lru_cache.dart';
import 'package:flutter_advance_image_picker/lib/src/engine/throttle.dart';
...
import 'package:flutter_advance_image_picker/lib/src/provider/gallery_list_provider.dart';
...
import 'package:flutter_advance_image_picker/lib/src/ui/dialog/change_gallery_dialog.dart';
import 'package:flutter_advance_image_picker/lib/src/ui/page/photo_preview_page.dart';
...
class _PhotoMainPageState extends State<PhotoMainPage>
  ...
  void _cancel() {
    selectedList.clear();
    widget.onClose(PhotoPickerProvider.of(context).pickedAssetList);
  }
